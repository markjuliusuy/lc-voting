    ...
    <div class="idea-container bg-white rounded-xl flex">
        ...
        <div class="buttons-container flex items-center justify-between mt-6">
            ...
            <div class="hidden md:flex items-center space-x-3">
                ...
                @if ($hasVoted)
                    <button type="button" class="flex items-center justify-center bg-blue text-white w-32 h-11 font-semibold uppercase rounded-xl border border-blue hover:bg-blue-hover transition duration-150 ease-in px-6 py-3">
                        <span>Voted</span>
                    </button>
                @else
