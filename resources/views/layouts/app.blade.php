...
<body class="font-sans bg-gray-background text-gray-900 text-sm">
    ...
    <main class="container mx-auto flex max-w-custom">
        <div class="w-70 mr-5">
            Add idea form goes here. Lorem ipsum dolor sit amet consectetur, adipisicing elit. Molestiae praesentium
            adipisci quibusdam soluta aspernatur repudiandae itaque repellat inventore, eveniet, distinctio rerum quasi
            officia? Asperiores dolore, nostrum dicta ut nam fuga odit officia neque eum culpa dolores. Perferendis
            dolorem assumenda quam.
        </div>
        <div class="w-175">
