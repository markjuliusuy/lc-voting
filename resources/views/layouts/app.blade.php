            ...
            background-clip: content-box, border-box;">
                ...
                @else
                    <div class="my-6 text-center">
                        <a href="{{ route('login') }}" class="inline-block justify-center bg-blue text-white w-1/2 h-11 font-semibold rounded-xl border border-blue hover:bg-blue-hover transition duration-150 ease-in px-6 py-3">
                            Login
                        </a>
                        <a href="{{ route('register') }}" class="inline-block justify-center bg-gray-200  w-1/2 h-11 font-semibold rounded-xl border border-gray-200 hover:bg-gray-400 transition duration-150 ease-in px-6 py-3 mt-4">
                            Sign Up
                        </a>
                    </div>
                @endauth
