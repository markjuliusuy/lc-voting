    ...
    <div class="idea-container bg-white rounded-xl flex">
        ...
        <div class="buttons-container flex items-center justify-between mt-6">
            <div class="flex items-center space-x-4 ml-6">
                <div class="relative">
                    <button type="submit" class="flex items-center justify-center bg-blue text-white w-32 h-11 font-semibold rounded-xl border border-blue hover:bg-blue-hover transition duration-150 ease-in px-6 py-3 text-sm">
                        Reply
                    </button>
                ...
                <div class="relative">
                    <button type="button" class="flex items-center justify-center bg-gray-200 w-36 h-11 font-semibold rounded-xl border border-gray-200 hover:border-gray-400 transition duration-150 ease-in px-6 py-3 text-sm">
