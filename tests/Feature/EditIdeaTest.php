...
class EditIdeaTest extends TestCase
{
    ...
    /** @test */
    public function editing_an_idea_does_not_work_when_user_has_authorization_because_different_user_created_idea()
    {
        $user = User::factory()->create();
    ...
    /** @test */
    public function editing_an_idea_does_not_work_when_user_has_authorization_because_idea_was_created_longer_than_an_hour_ago()
    {
        $user = User::factory()->create();
        $userB = User::factory()->create();
